...
void main()
{
    ...
    offset[0] = pixel_size.xyxy * vec4(-0.25, 0.125, 1.25, 0.125) + aTexCoords.xyxy * resolution;
    offset[1] = pixel_size.xyxy * vec4(-0.125, 0.25, -0.125, -1.25) + aTexCoords.xyxy * resolution;
